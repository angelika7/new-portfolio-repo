...
const Header = (props) => {
    ...
    <header className={classes.header} id='home'>
        ...
        <div className={classes.content}>
            <motion.div ref={ref} className={classes.sloganBox} initial="hidden" animate={controls} exit="hidden" variants={variantsSlogan}>
                <h1 className={styles.headingPrimary}>Front-end Developer</h1>
            </motion.div>
            <motion.div ref={ref} initial="hidden" animate={controls} exit="hidden" variants={variantsImg} className={classes.imgBox}>
