...
const data = {
    projects: [
        {id: 0, url: url1, alt: 'Zdjęcie aplikacji - Re-reading books', info: 'Aplikacja do sprzedaży książek', title: '"Re-reading books" APP W BUDOWIE', backInfo:`${check} HTML5 (Pug) ${check} CSS3 (SCSS) ${check} JS ${check} Express.js ${check} MongoDB + Mongoose`, isFlipped: false, live: '.', github: '.', isActive: false},
