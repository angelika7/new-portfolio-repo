...
const data = {
    projects: [
        ...
        {id: 1, url: url9, alt: 'Zdjęcie aplikacji - Portfolio v2.0', info: 'Strona internetowa', title: '"Portfolio v2.0"', isFlipped: false, backInfo: `${check} React.js ${check} CSS3 (SCSS) ${check} JS`, live: 'https://angelika7.github.io/portfolioV2/', github: 'https://github.com/angelika7/portfolioV2', isActive: true},
        {id: 2, url: url8, alt: 'Zdjęcie aplikacji - MemoCats App', isActive: true, info: 'Aplikacja memo - gra', title: '"MemoCats App"', isFlipped: false, backInfo: `${check} React.js ${check} Redux ${check} JS ${check} CSS3 + SVG ${check} Firebase`, live: 'https://angelika7.github.io/memo-cats-app/', github: 'https://github.com/angelika7/memo-cats-app'},
